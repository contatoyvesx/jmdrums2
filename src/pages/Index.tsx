      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          ...
          <div className="animate-fade-up-delay-2 mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button variant="whatsapp" size="lg" asChild className="text-base px-8 py-6 rounded-full glow-whatsapp animate-pulse-glow">
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer">
                <MessageCircle className="mr-2 h-5 w-5" />
                Ver produtos no WhatsApp
              </a>
            </Button>
            <a href="#sobre" className="animate-fade-up-delay-3 text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1">
            ...
            {steps.map((s, i) => (
              <RevealOnScroll key={s.num} delay={i * 150}>
                <div className="glass-card rounded-2xl p-8 relative group hover:scale-[1.02] transition-transform duration-300">
                  <span className="text-5xl font-black text-foreground/5 absolute top-4 right-6 group-hover:text-whatsapp/10 transition-colors">{s.num}</span>
          ...
          <RevealOnScroll>
            <div>
              ...
              <div className="mt-10 space-y-5">
                <a href="https://wa.me/5511947483998" className="glass-card flex items-center gap-4 rounded-2xl p-5 hover:scale-[1.02] transition-transform duration-300">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-whatsapp/10">
        ...
        <div className="relative z-10 mx-auto max-w-2xl text-center">
          <RevealOnScroll>
            <div>
              ...
              <div className="mt-10">
                <Button variant="whatsapp" size="lg" asChild className="text-base px-10 py-7 rounded-full glow-whatsapp text-lg font-bold">
                  <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer">
      ...
      <footer className="border-t border-border/50 px-6 py-10">
        <div className="mx-auto max-w-5xl flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://instagram.com/jmdrumsabc" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
